...
*   Build the example application:
          ...
          cd ~/connectedhomeip
          ./scripts/examples/gn_efr32_example.sh ./examples/window-app/silabs/SiWx917/ ./out/window-app BRD4352B --wifi SiWx917
...
chip_progress_logging, chip_detail_logging, chip_automation_logging
    ...
    $ ./scripts/examples/gn_efr32_example.sh ./examples/window-app/silabs/SiWx917 ./out/window-app BRD4352B "chip_detail_logging=false chip_automation_logging=false chip_progress_logging=false" --wifi SiWx917

### Debug build / release build

is_debug

    $ ./scripts/examples/gn_efr32_example.sh ./examples/window-app/silabs/SiWx917 ./out/window-app BRD4352B "is_debug=false" --wifi SiWx917

### Disabling LCD

show_qr_code

    $ ./scripts/examples/gn_efr32_example.sh ./examples/window-app/silabs/SiWx917 ./out/window-app BRD4352B "show_qr_code=false" --wifi SiWx917
...
kvs_max_entries
    ...
    $ ./scripts/examples/gn_efr32_example.sh ./examples/window-app/silabs/SiWx917 ./out/window-app BRD4352B kvs_max_entries=50 --wifi SiWx917